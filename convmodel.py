...
def myModel(X, reuse=False):
    with tf.variable_scope('ConvNet', reuse=reuse):
        ...
        h = tf.layers.dense(inputs=tf.reshape(o4, [batch_size * 5, 18 * 33 * 64]), units=20, activation=tf.nn.relu)
...
example_batch_train, label_batch_train = dataSource(["./8data/train/0/*.jpg", "./8data/train/1/*.jpg",
                                                     "./8data/train/2/*.jpg", "./8data/train/3/*.jpg",
                                                     "./8data/train/4/*.jpg"], batch_size=batch_size)
example_batch_valid, label_batch_valid = dataSource(["./8data/valid/0/*.jpg", "./8data/valid/1/*.jpg",
                                                     "./8data/valid/2/*.jpg", "./8data/valid/3/*.jpg",
                                                     "./8data/valid/4/*.jpg"], batch_size=batch_size)
example_batch_test, label_batch_test = dataSource(["./8data/test/0/*.jpg", "./8data/test/1/*.jpg",
                                                   "./8data/test/2/*.jpg", "./8data/test/3/*.jpg",
                                                   "./8data/test/4/*.jpg"], batch_size=batch_size)
